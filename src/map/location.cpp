...
map_location map_location::rotate_right_around_center(const map_location & center, int k) const {
	...
	auto vec = hex_location{me_as_cube.q - c_as_cube.q, me_as_cube.r - c_as_cube.r, me_as_cube.s - c_as_cube.s};
	...
	static const int rotations[6][3] = {{1,2,3}, {-3,-1,-2}, {2,3,1}, {-1,-2,-3}, {3,1,2}, {-2,-3,-1}};
